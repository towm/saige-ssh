									...
									<tbody>
										<c:forEach items="${ptasks}" var="ptask">
											<tr>
												...
												<td><a
													href="/lyn-ssh/task/subTaskListP.do?listid=${ptask.listid}"><c:out
															value="${ptask.listid}" /></a></td>
												<td><li class="dropdown"><a href="javascript:;"
														class="dropdown-toggle" data-toggle="dropdown"><c:out
																value="${ptask.progress}" /><b class="caret"></b></a>
														<ul class="dropdown-menu">
															<li><a
																href="/lyn-ssh/task/updatePTaskStatus.do?id=${ptask.id}&status=0">Set
																	Not Started</a></li>
															<li><a
																href="/lyn-ssh/task/updatePTaskStatus.do?id=${ptask.id}&status=1">Set
																	In Progress 20%</a></li>
															<li><a
																href="/lyn-ssh/task/updatePTaskStatus.do?id=${ptask.id}&status=2">Set
																	In Progress 50%</a></li>
															<li><a
																href="/lyn-ssh/task/updatePTaskStatus.do?id=${ptask.id}&status=3">Set
																	In Progress 80%</a></li>
															<li><a
																href="/lyn-ssh/task/updatePTaskStatus.do?id=${ptask.id}&status=4">Set
																	Completed</a></li>

														</ul></li></td>
												<td><c:out value="${ptask.quality}" /></td>
												<td><span class="badge bg-${ptask.priority}"><c:out
															value="${ptask.priority}" /></span></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
