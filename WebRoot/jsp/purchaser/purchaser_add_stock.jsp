					...
					<div class="col-lg-12">
						<section class="panel">
							...
							<div class="panel-body">
								<div class="form">
									<form class="form-validate form-horizontal" id="add_ptask_form"
										method="post" action="/lyn-ssh/task/addPTask.do">
										<div class="form-group ">
											<label for="cname" class="control-label col-lg-2">Purchase
										...
										<div class="form-group ">
											...
											<div class="col-lg-10">
												...
												<select name="progress" form="add_ptask_form"
										...
										<div class="form-group ">
											<label for="cname" class="control-label col-lg-2">Task-Related
												List id <span class="required">*</span>
											</label>
											<div class="col-lg-10">
												<input class="form-control " id="cname" type="number"
													name="listid" required />
											</div>
										</div>
										...
										<div class="form-group ">
											...
											<div class="col-lg-10">
												...
												<select name="priority" form="add_ptask_form"
													class="form-control m-bot15">
