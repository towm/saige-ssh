			...
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu"><a href="javascript:;" class=""> <i
						...
						<ul class="sub">
							<li></li>
							<li><a class="" href="/lyn-ssh/jsp/stock/stock_insert.jsp">Stock
									Task Form</a></li>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<div class="panel-actions">
									<a href="manager_index.jsp#" class="btn-setting"><i
										class="fa fa-rotate-right"></i></a> <a href="manager_index.jsp#"
										class="btn-minimize"><i class="fa fa-chevron-up"></i></a> <a
										href="manager_index.jsp#" class="btn-close"><i
