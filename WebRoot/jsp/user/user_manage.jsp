...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">Lyn <span class="lite">Workshop</span></a>
      <!--logo end-->
        ...
        <div class="col-lg-12">
                ...
                <tbody>
                     ...
                     <c:forEach items="${users}" var="user">
                        <tr>
                            ...
                            <td>
                              <div class="btn-group">
                                 <a class="btn btn-primary" href="#add_User_Modal" data-toggle="modal"><i class="icon_plus_alt2"></i></a>
                                 <a class="btn btn-success" href="#update_User_Modal" data-toggle="modal"><i class="icon_pencil-edit_alt"></i></a>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <a href="#update_User_Modal" data-toggle="modal" class="btn btn-primary" >
                                  User Update Form Modal
                              </a>
                <a href="#add_User_Modal" data-toggle="modal" class="btn btn-primary" >
                                  User Insert Form Modal
                              </a>
              <!-- modal for add user start -->
                <div aria-hidden="true" aria-labelledby="add_User" role="dialog" tabindex="-1" id="add_User_Modal" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button aria-hidden="true" data-dismiss="modal" class="close" type="button">¡Á</button>
                        <h4 class="modal-title">User Insert Form</h4>
                      </div>
                      <div class="modal-body">

           <form id="add_user_form" role="form" action="addUser.do" method="post">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input name="city" class="form-control" id="exampleInputEmail1" placeholder="City">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <select  onchange="this.form.submit()" name="role" form="add_user_form" class="form-control m-bot15">
                  ...
                  <div class="form-group">
                    ...
                    <input name="phone" type="tel" class="form-control" id="exampleInputEmail1" placeholder="Phone Number">
                  </div>
                  <div class="form-group">
                ...
                <!-- modal for update user start -->
                 <div aria-hidden="true" aria-labelledby="update_User" role="dialog" tabindex="-1" id="update_User_Modal" class="modal fade">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button aria-hidden="true" data-dismiss="modal" class="close" type="button">¡Á</button>
      ...
      <form id="update_user_form" role="form">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="control-label col-lg-2" for="inputSuccess">Role</label>
                    <div class="col-lg-10">
                      <select  onchange="this.form.submit()" name="role" form="update_user_form" class="form-control m-bot15">
  ...
  <!-- ck editor -->
  <script type="/lyn-ssh/text/javascript" src="assets/ckeditor/ckeditor.js"></script>
