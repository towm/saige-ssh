...
<!--logo start--> <a href="/lyn-ssh/jsp/manager/manager_index.jsp"
	class="logo">Lyn <span class="lite">Workshop</span></a> <!--logo end-->
	...
	<ul class="nav pull-right top-menu">
		...
		<li id="task_notificatoin_bar" class="dropdown"><a
			data-toggle="dropdown" class="dropdown-toggle" href="#"> <i
				class="icon-task-l"></i> <span class="badge bg-important">${bars_len}</span>
		</a>
				...
				<c:forEach items="${bars}" var="bar">
					<li><a href="#">
							...
							<div class="progress progress-striped active">
								<div class="progress-bar progress-bar-${bar.color}"
									role="progressbar" aria-valuenow="${bar.width}"
