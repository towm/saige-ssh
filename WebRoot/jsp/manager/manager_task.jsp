...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="/lyn-ssh/jsp/manager/manager_index.jsp" class="logo">Nice <span class="lite">Admin</span></a>
      <!--logo end-->
      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="/lyn-ssh/jsp/manager/manager_index.jsp">Home</a></li>
