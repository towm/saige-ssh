											...
											<tr>
												...
												<td><li class="dropdown"><a href="javascript:;"
														class="dropdown-toggle" data-toggle="dropdown"><c:out
																value="${task.progress}" /><b class="caret"></b></a>
														<ul class="dropdown-menu">
															<li><a
																href="updateTaskStatus.do?id=${task.id}&status=0">Set
																	Not Started</a></li>
															<li><a
																href="updateTaskStatus.do?id=${task.id}&status=1">Set
																	In Progress 20%</a></li>
															<li><a
																href="updateTaskStatus.do?id=${task.id}&status=2">Set
																	In Progress 50%</a></li>
															<li><a
																href="updateTaskStatus.do?id=${task.id}&status=3">Set
																	In Progress 80%</a></li>
															<li><a
																href="updateTaskStatus.do?id=${task.id}&status=4">Set
																	Completed</a></li>
