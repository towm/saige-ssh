...
<body>
	<form id="form" action="user/url.do" method="post">
		...
		<div class="form-group">
			<label for="name">sex</label> <input type="text" class="form-control"
				id="sex" name="sex" placeholder="请输入性别">
		</div>

		<div class="form-group">
			<label for="name">email</label> <input type="text"
				class="form-control" id="email" name="email" placeholder="请输入email">
		</div>
		<div class="form-group">
			<label for="id">id</label> <input type="text" class="form-control"
				id="email" name="id" placeholder="请输入id">
		</div>
		...
		<div class="checkbox">
			<label> <input type="checkbox" name="check"> 请打勾
			</label>
		</div>
